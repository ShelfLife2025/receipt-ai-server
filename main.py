...
FOOD_KNOWLEDGE_FALLBACK: Dict[str, Dict] = {
    ...
    # ── BREAD & BAKERY ───────────────────────────────────────────────────────
    "bread":                 {"expires_in_days": 7,    "storage": "pantry",  "category": "Food"},
    "sandwich bread":        {"expires_in_days": 10,   "storage": "pantry",  "category": "Food"},
    "sourdough":             {"expires_in_days": 7,    "storage": "pantry",  "category": "Food"},
    "bagels":                {"expires_in_days": 7,    "storage": "pantry",  "category": "Food"},
    "english muffins":       {"expires_in_days": 7,    "storage": "pantry",  "category": "Food"},
    "tortillas":             {"expires_in_days": 14,   "storage": "pantry",  "category": "Food"},
    "flour tortillas":       {"expires_in_days": 14,   "storage": "pantry",  "category": "Food"},
    "corn tortillas":        {"expires_in_days": 14,   "storage": "pantry",  "category": "Food"},
    "dinner rolls":          {"expires_in_days": 14,   "storage": "pantry",  "category": "Food"},
    "sweet rolls":           {"expires_in_days": 14,   "storage": "pantry",  "category": "Food"},
    "hawaiian rolls":        {"expires_in_days": 14,   "storage": "pantry",  "category": "Food"},
    "king's hawaiian":       {"expires_in_days": 14,   "storage": "pantry",  "category": "Food"},
    "savory rolls":          {"expires_in_days": 14,   "storage": "pantry",  "category": "Food"},
    "hamburger buns":        {"expires_in_days": 10,   "storage": "pantry",  "category": "Food"},
    "hot dog buns":          {"expires_in_days": 10,   "storage": "pantry",  "category": "Food"},
    "pita bread":            {"expires_in_days": 7,    "storage": "pantry",  "category": "Food"},
    "croissants":            {"expires_in_days": 3,    "storage": "pantry",  "category": "Food"},
    "muffins":               {"expires_in_days": 5,    "storage": "pantry",  "category": "Food"},
    "donuts":                {"expires_in_days": 3,    "storage": "pantry",  "category": "Food"},
    "cake":                  {"expires_in_days": 5,    "storage": "pantry",  "category": "Food"},
    "garlic bread":          {"expires_in_days": 90,   "storage": "freezer", "category": "Food"},
    "pretzel buns":          {"expires_in_days": 7,    "storage": "pantry",  "category": "Food"},
    "brioche":               {"expires_in_days": 7,    "storage": "pantry",  "category": "Food"},
